...
import { CheckEmail } from 'features/auth/components/password-recovery/component';
import { passwordRecoveryLink } from 'features/auth/components/password-recovery/reducer';
