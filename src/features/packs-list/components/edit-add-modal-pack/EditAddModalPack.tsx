...
import style from 'features/packs-list/components/Cards/components/AddEditModalCards/style/EditAddModalCard.module.css';
  ...
  return (
    ...
    >
      ...
      <FormGroup style={{ marginBottom: '15px' }}>
        <FormControlLabel
          label="Private pack"
          control={<Checkbox checked={isPrivate} onChange={onChangeIsPrivateHandler} />}
        />
      </FormGroup>
    </CustomModal>
  );
